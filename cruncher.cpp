...
int main(int argc, char *argv[])
{
	...
	person_map = (Person *)mmapr(makepath((char *)query_path, (char *)"location_friends_person", (char *)"bin"), &person_length);
	interest_map = (unsigned short *)mmapr(makepath((char *)query_path, (char *)"interest", (char *)"bin"), &interest_length);
	knows_map = (unsigned int *)mmapr(makepath((char *)query_path, (char *)"location_friends_knows", (char *)"bin"), &knows_length);
